...
export const infoList = [
    { icon: assets.code_icon, iconDark: assets.code_icon_dark, title: 'Established Since', description: '1234' },
    { icon: assets.edu_icon, iconDark: assets.edu_icon_dark, title: 'Projects Done', description: '30+ and counting' },
    { icon: assets.project_icon, iconDark: assets.project_icon_dark, title: 'Company Partners', description: 'Person 1, Person 2, and Person 3' }
];
